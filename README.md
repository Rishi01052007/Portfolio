...
<body>
    ...
    <section id="home" class="home">
        <h1>Hi, I'm <span>RISHI R</span></h1>
        <p>212224040277</p>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>
        Hello! I’m <strong>RISHI R</strong>, a passionate and motivated student
    ...
    <section id="contact" class="contact">
        <h2>Contact Me</h2>
        <p>Email: jaganrishi157@gmail.com</p>
        <p>Github: https://github.com/Rishi01052007</p>
        <p>Phone: 9629550723</p>
    </section>
...
![alt text](<Screenshot 2026-02-13 105601.png>)
![alt text](<Screenshot 2026-02-13 105618.png>)
